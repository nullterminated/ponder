...
public class DirectAction extends R2D2WDirectAction {
    ...
    /**
     * Since the default for WO is to return a content-type of text/html, we
     * need a way to override that behavior for direct actions. This is a
     * simple wrapper class to force any response with a content-type of
     * text/html to use application/xhtml+xml instead.
     */
