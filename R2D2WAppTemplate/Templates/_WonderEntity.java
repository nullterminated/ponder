...
#foreach ($lang in $attribute.userInfo.ERXLanguages)
  ...
  public $attribute.userInfo.ERXConstantClassName ${attribute.name}_${lang}() {
    Number value = (Number)storedValueForKey(${attribute.uppercaseUnderscoreName}_${lang.toUpperCase()}_KEY);
  ...
  public void set${attribute.capitalizedName}_${lang}($attribute.userInfo.ERXConstantClassName value) {
    takeStoredValueForKey(value, ${attribute.uppercaseUnderscoreName}_${lang.toUpperCase()}_KEY);
  }
#else
  public $attribute.javaClassName ${attribute.name}_${lang}() {
    return ($attribute.javaClassName) storedValueForKey(${attribute.uppercaseUnderscoreName}_${lang.toUpperCase()}_KEY);
  }
